...
private:
	virtual void Draw()
	{
		...
		BasicObject* glass = new BasicObject("test/lucy", "nanosuit/glass", "bricks", glassTrans);
		BasicObject* mirror = new BasicObject("test/lucy", "nanosuit/mirror", "bricks", mirrorTrans);
