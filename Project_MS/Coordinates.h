...
public:
	...
	void Draw()
	{
		...
		glLineWidth(3);
		coor_shader->SetLineColor(glm::vec4(1.0, 0.0, 0.0, 1.0));	coordinate_x->DrawLines();
		coor_shader->SetLineColor(glm::vec4(0.0, 1.0, 0.0, 1.0));	coordinate_y->DrawLines();
		coor_shader->SetLineColor(glm::vec4(0.0, 0.0, 1.0, 1.0));	coordinate_z->DrawLines();
	}
